...
public class SimulatorTest {
    ...
    @Ignore
    @Test
    public void test_simulator_with_epsilon_greedy() throws IOException {
        fw = new FileWriter("epsilonGreedy");
        ...
        for (int i = 0; i < 5000; i++) {
            ...
            counter(bagNumber);
            content += String.valueOf(bagNumber) + "\t";
    ...
    @Ignore
    @Test
    public void test_simulator_optimal_with_initial_values() throws IOException {
        fw = new FileWriter("optimalInitialValues");
    ...
    @Ignore
    @Test
    public void test_simulator_with_reinforcement_comparison() throws IOException {
        fw = new FileWriter("reinforcementComparison");
        double epsilon = 0.35;
        for (int i = 0; i < 5000; i++) {
    ...
    @Ignore
    @Test
    public void test_simulator_with_pursuit_methods() throws IOException {
        fw = new FileWriter("pursuitMethods");
        double epsilon = 0.35;
        double beta = 0.01;
        for (int i = 0; i < 5000; i++) {
            bagNumber = bandit.epsilonReinforcementComparison(epsilon);
